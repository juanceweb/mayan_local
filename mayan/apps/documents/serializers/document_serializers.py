...
from ...unq.models.solicitudes.solicitud_campo import Solicitud_Campo, Solicitud_Campo_Tipo
from ...unq.serializers.solicitudes.serializer_solicitud import Solicitud_Serializer
...
class DocumentSerializer(serializers.HyperlinkedModelSerializer):
    ...
    solicitud = Solicitud_Serializer(read_only=True)
    ...
    class Meta:
        ...
        fields = (
            ...
            'version_active', 'version_list_url', 'solicitud', 'campos'
        )
        ...
        read_only_fields = (
            ...
            'version_list_url', 'campos'
        )

    def get_campos(self, obj):
        all_campos = Solicitud_Campo.objects.filter(solicitud_id = obj.solicitud_id).distinct()
        ...
        for campo in all_campos:
            ...
            try:
                tipo = Solicitud_Campo_Tipo.objects.get(nombre_campo = campo.nombre_campo)

                if tipo.tipo_campo == "array":
                    valor_json = json.loads(campo.valor_campo)
                    res.update( { campo.nombre_campo : valor_json } )
                else:
                    res.update( { campo.nombre_campo : campo.valor_campo } )
            except:
                logger.error(campo.nombre_campo)
...
class DocumentUploadSerializer(DocumentSerializer):
    ...
    class Meta(DocumentSerializer.Meta):
        ...
        fields = (
            ...
            'version_active', 'version_list_url', 'solicitud'
        )
